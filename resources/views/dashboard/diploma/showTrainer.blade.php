                            ...
                            <div class="card-body pt-0 pb-3">
                                <div class="row clearfix">
                                    ...
                                    {{-- <div class="form-group col-md-6">
                                        ...
                                        <input type="text" value="{{$group->group_name.' '. $group->group_number }}"
                                            class="form-control form-control-solid" disabled />
                                    </div> --}}
                                    <div class="form-group col-md-6">
                                        <label> تاريخ ميلاد المدرب:</label>
                                        <input type="text" value="{{$trainer->user->date_of_birth}} "
                                            class="form-control form-control-solid" disabled />
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" value="{{ $trainer->user->mobile}} "
                                            class="form-control form-control-solid" disabled />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label> التخصص:</label>
                                        <input type="text" value="{{$trainer->user->speciality}} "
                                            class="form-control form-control-solid" disabled />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label> المسمى الوظيفي:</label>
                                        <input type="text" value="{{$trainer->user->job_title}} "
                                            class="form-control form-control-solid" disabled />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label> الراتب:</label>
                                        <input type="text" value="{{ $trainer->user->salary_value}} "
                                            class="form-control form-control-solid" disabled />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label> نوع الراتب:</label>
                                        <input type="text" value="{{$trainer->user->salary_type}} "
                                            class="form-control form-control-solid" disabled />
                                    </div>
                    </div>
