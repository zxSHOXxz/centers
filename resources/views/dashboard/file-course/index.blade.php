            ...
            <div class="card-tools">
                <form action="" method="get" >
                    ...
                    <div >
                          ...
                          <a href="{{route('indexCourse' , $id)}}"><button type="button" class="btn btn-info"> قائمة المساقات </button></a>
                          <a href="{{ route('createCFile' , $id) }}" class="btn btn-primary" style="color: white;"> إضافة ملف للمساق </a>
