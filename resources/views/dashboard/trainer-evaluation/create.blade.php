...
@section('title',' تقيم المدربين ')

@section('sub-title',' تقييم المدربين  ')

@section('active title',' إضافة تقييم المدربين ')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">عرض تقيم المدربين </h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="create_form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('indexTrainer' , $id)}}"><button type="button" class="btn btn-lg btn-primary"> قائمة التقيم </button></a>
...
<script>
    function performStore() {
        ...
        store('/cms/admin/trainer_evalutions', formData);
