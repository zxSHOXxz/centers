                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="room_id" style="width: 100%;" id="room_id" aria-label=".form-select-sm example">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="dayes" style="width: 100%;" id="dayes" aria-label=".form-select-sm example">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="diploma_id" style="width: 100%;" id="diploma_id" aria-label=".form-select-sm example">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="trainer_id"
                                        ...
                                        <option value="{{ $trainer->id }}">{{ $trainer->user?$trainer->user->first_name:'null' }}</option>
